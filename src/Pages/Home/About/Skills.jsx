...
<img src={skill6} alt="HTML" className='mx-auto w-10 h-10'/>
<div className='absolute bg-primary w-full h-full rounded-full top-0 left-0 opacity-0 hover:opacity-100 transition-opacity duration-200  text-2xl font-extrabold text-white'>
<h1 className='w-full h-full flex justify-center items-center'>80%</h1>
    </div>
</div>
...
<img src={skill9} alt="HTML" className='mx-auto w-10 h-10'/>
<div className='absolute bg-primary w-full h-full rounded-full top-0 left-0 opacity-0 hover:opacity-100 transition-opacity duration-200  text-2xl font-extrabold text-white'>
...
<img src={skill8} alt="HTML" className='mx-auto w-10 h-10'/>
<div className='absolute bg-primary w-full h-full rounded-full top-0 left-0 opacity-0 hover:opacity-100 transition-opacity duration-200  text-2xl font-extrabold text-white'>
<h1 className='w-full h-full flex justify-center items-center'>50%</h1>
    </div>
</div>

<div className='relative py-10 px-10 border-8 rounded-full text-center border-primary border-opacity-100 hover:border-opacity-30 transition-all duration-300'>
    
<img src={skill3} alt="HTML" className='mx-auto w-10 h-10'/>
<div className='absolute bg-primary w-full h-full rounded-full top-0 left-0 opacity-0 hover:opacity-100 transition-opacity duration-200  text-2xl font-extrabold text-white'>
...
<img src={skill7} alt="HTML" className='mx-auto w-10 h-10'/>
<div className='absolute bg-primary w-full h-full rounded-full top-0 left-0 opacity-0 hover:opacity-100 transition-opacity duration-200  text-2xl font-extrabold text-white'>
...
<img src={skill4} alt="HTML" className='mx-auto w-10 h-10'/>
<div className='absolute bg-primary w-full h-full rounded-full top-0 left-0 opacity-0 hover:opacity-100 transition-opacity duration-200  text-2xl font-extrabold text-white'>
<h1 className='w-full h-full flex justify-center items-center'>80%</h1>
    </div>
</div>
