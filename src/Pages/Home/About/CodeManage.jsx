        ...
        <section className='my-10 lg:my-14'>
            <div>
                <div className='text-center'>
                    <p className='text-gradient font-bold text-3xl mb-3'>Coding Structure</p>
                    <h1 className="text-3xl lg:text-4xl font-bold">How do I organize of my coding structure</h1>
                </div>
